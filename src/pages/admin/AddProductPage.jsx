                ...
                <div className="login_Form bg-blue-50 px-8 py-6 border border-blue-100 rounded-xl shadow-md">
                    ...
                    <div className="mb-3">
                        <select
                            ...
                            <option disabled value="">Seleccionar Categoria del Producto</option>
                            {categoryList.map((value, index) => {
                                const { name } = value;
                                const capitalizedName = name.charAt(0).toUpperCase() + name.slice(1); // Capitalizar primera letra

                                return (
                                    <option key={index} value={name}>{capitalizedName}</option>
                                );
                            })}
                        </select>
                    </div>
                    ...
                    <div className="mb-3">
                        <textarea
                            ...
                            }} name="description" placeholder="Descripcion del Producto" rows="5" className=" w-full px-2 py-1 text-blue-300 bg-blue-50 border border-blue-200 rounded-md outline-none placeholder-blue-300 ">
                        </textarea>
                    </div>
                    {/* Add Product Button  */}
                    <div className="mb-3">
