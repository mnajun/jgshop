...
const UserDashboard = () => {
    ...
    const gender = user?.gender || 'male'; // Obtener el género del usuario o establecer un valor predeterminado

    const getImageSrc = () => {
        if (gender === 'male') {
            return 'https://cdn-icons-png.flaticon.com/128/2202/2202112.png'; // Hombre
        } else if (gender === 'female') {
            return 'https://www.devknus.com/img/gawri.png'; // Mujer
        } else {
            return 'https://i.ibb.co/0G9yCcy/nobinario.png'; // No binario
        }
    };

    const getAvatarColor = () => {
        if (gender === 'male') {
            return 'bg-blue-50 py-5 rounded-xl border border-blue-200'; // Azul para género masculino
        } else if (gender === 'female') {
            return 'bg-pink-50 py-5 rounded-xl border border-pink-200'; // Rosa para género femenino
        } else {
            return 'bg-brown-50 py-5 rounded-xl border border-brown-200'; // Marrón para no binario
        }
    };
    ...
    return (
        <Layout>
            ...
            <div className=" container mx-auto px-4 py-5 lg:py-8">
                ...
                <div className="top ">
                    {/* main  */}
                    <div className={`avatar ${getAvatarColor()}`}>
                        {/* image  */}
                        <div className="flex justify-center">
                        <img src= {getImageSrc()} alt="Avatar" />
                        </div>
                        {/* text  */}
                        <div className="">
                            {/* Name  */}
                ...
                <div className="bottom">
                    ...
                    <div className="mx-auto my-4 max-w-6xl px-2 md:my-6 md:px-0">
                        {/* text  */}
                        <h2 className=" text-2xl lg:text-3xl font-bold">Detalle de la Orden</h2>
                                                ...
                                                <div className="w-full border-r border-pink-100 bg-pink-50 md:max-w-xs">
                                                    ...
                                                    <div className="p-8">
                                                        <div className="grid grid-cols-2 sm:grid-cols-4 md:grid-cols-1">
                                                            ...
                                                            <div className="mb-4">
                                                                <div className="text-sm font-semibold">Total a Abonar</div>
