...
const Signup = () => {
    ...
    *========================================================================**/
    ...
    return (
        <div className='flex justify-center items-center h-screen'>
            ...
            <div className="login_Form bg-blue-50 px-8 py-6 border border-blue-100 rounded-xl shadow-md">
                ...
                {/* Gender Selection */}
                <div className="mb-5">
    <p className='text-center mb-2'>Seleccione su sexo:</p>
    <div className="flex justify-center items-center space-x-2">
        ...
        <input type="radio" id="non-binary" name="gender" value="non-binary" checked={gender === "non-binary"} onChange={handleGenderChange} />
