...
const CartPage = () => {
    ...
    const formattedcartItemTotal = cartTotal.toLocaleString('es-ES', {
        minimumFractionDigits: 2,
        maximumFractionDigits: 2
    });
    
    const formattedCartTotal = cartTotal.toLocaleString('es-ES', {
        minimumFractionDigits: 2,
        maximumFractionDigits: 2
    });
                                                    ...
                                                    <div className="mb-2 flex">
                                                        ...
                                                        <div className="ml-6 flex text-sm">
                                                            <button onClick={() => deleteCart(item)} type="button" className="flex items-center space-x-1 px-2 py-1 pl-0">
                                                                ...
                                                                <span className="text-xs font-medium text-red-500">Borrar</span>
                                                            </button>
                                                        </div>
                                                    </div>
                                                </div>
                            ...
                            <div>
                                <dl className=" space-y-1 px-2 py-4">
                                    <div className="flex items-center justify-between">
                                        ...
                                        <dd className="text-sm font-medium text-gray-900">$ {formattedcartItemTotal}</dd>
                                    </div>
                                    ...
                                    <div className="flex items-center justify-between border-y border-dashed py-4 ">
                                        ...
                                        <dd className="text-base font-medium text-gray-900">${formattedCartTotal}</dd>
                                    </div>
                                </dl>
